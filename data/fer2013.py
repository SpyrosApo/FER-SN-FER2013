...
def get_dataloaders(path='./fer2013/fer2013.csv', bs=64, augment=True):
    ...
    #default bs=64 in test and val
    trainloader = DataLoader(train, batch_size=bs, shuffle=True, num_workers=0)
    valloader = DataLoader(val, batch_size=40, shuffle=True, num_workers=0)
    testloader = DataLoader(test, batch_size=40, shuffle=True, num_workers=0)
